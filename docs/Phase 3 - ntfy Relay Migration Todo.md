...
- [ ] Should pairing move to QR-code setup later so one phone can scan server URL, pair ID, and pair secret from the other phone instead of typing/copying them manually?
